...
//    this->root = balanceHelper(this->root, stonk);
//}
//
...
//}
//
//RedBlack::Node *RedBlack::balanceHelper(RedBlack::Node *node, Stock stonk) {
//    if(stonk.adjClose < node->adjClose) {
//        node->left = balanceHelper(node->left, stonk);
//    }
//    else if (stonk.adjClose > node->adjClose) {
//        node->right = balanceHelper(node->right, stonk);
//    }
//
...
//                    this->root = rotateLeft(grandpa);
//                }else if(grandpa->parent->left == grandpa){
//                    grandpa->parent->left = rotateLeft(grandpa);
//                }else{
//                    grandpa->parent->right =
//                }
